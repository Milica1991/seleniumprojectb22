...
public class DropdownPractices {
    ...
    public void tc1_simple_dropdown_test() {
        ...
        public void tc2_state_dropdown_test() throws InterruptedException {
            //Located state dropdown
            Select stateDropdown = new Select(driver.findElement(By.xpath("//select[@id='state']")));
            //3.Select Ilinois
        Thread.sleep(1000);
        stateDropdown.selectByVisibleText("Ilinois");
            //4.SelectVirginia
            Thread.sleep(1000);
            ...
            //6 Verify final selectd option is California
            ...
            Assert.assertEquals(actualOptionText, expectedOptionText,
                    "this message will be printed out only if assertion fail");
